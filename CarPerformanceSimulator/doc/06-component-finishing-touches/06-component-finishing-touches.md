...
Working on this portfolio project has really opened my eyes to the realities of software development. Before this, I used to think everything was about coding alone, but now I see how planning, testing, and continuous revisions play a huge role. I definitely have a better grasp of the real-world processes now, which makes me appreciate the complexity and the craftsmanship involved in building software.


> Also, did the portfolio project surface any gaps in your own knowledge of
> software development. If so, what are those gaps and how did you address them?

This project made me realize that my understanding of testing strategies and version control was quite shallow. I struggled initially to set up effective tests and manage my project versions. To tackle this, I spent extra time learning about JUnit testing and Git commands, which not only helped me complete the project but also equipped me with skills I'll use in future work.
...
I’ve always enjoyed coding, but this project made me love it even more because I got to see my code come to life and actually work as intended. However, the challenges also made me realize that software development requires patience and perseverance, which I need to continue developing.
...
• Developed a complete software component from concept through to implementation, incorporating OOP principles.
• Applied rigorous unit testing using JUnit to ensure functionality and reliability.
• Managed project versions and documentation using Git, enhancing collaboration and project tracking.
• Demonstrated ability to learn and apply new software tools and practices effectively

> Next, how has working on this project affected your career trajectory?
> In other words, do you now hate the topic you picked? Or, are you even more
> interested in it? Both outcomes are valuable to your personal development.

Working on this Car component has only deepened my interest in automotive software systems. I’m more excited than ever about the possibility of working in this area, possibly in developing software for electric vehicles or autonomous driving technologies.
...
To keep advancing, I plan to take more courses in advanced programming and perhaps a specialized course in automotive software systems. I also think it’s time to find a mentor in this field, maybe one of the guest speakers who recently talked about AI in automotive technologies, to guide me and provide professional insights.
