...
Hey! So, I'm really into cars and car games. I love everything about cars, especially playing games where I can race them. It's super fun to see how fast they can go and to mess around with car settings to make them even better. I also love playing soccer. It's awesome to be out there, working with my team and trying to score goals. Soccer's just really exciting to me. And I'm into machine learning too. It's cool because it's like teaching computers to learn by themselves. I think it's amazing how it can beused in games and sports to do all sorts of smart stuff.
...
- Component Design #1: Car Performance Simulator
  - **Description**: This component simulates car performance based on various inputs like engine type, horsepower, weight, and aerodynamics. It could be used in a car game to predict race outcomes or to design virtual cars.
  - **Kernel Methods**: setEngineType(String engineType), setHorsepower(int hp), setWeight(int weight), and calculateAcceleration().
  - **Secondary Methods**: simulateRace(Car opponent), which predicts race outcomes against another car, and optimizeDesign() which suggests modifications to improve performance.

<!-- TODO: brainstorm a component and delete this comment -->
- Component Design #2: Soccer Match PredictorSoccer Match Predictor
  - **Description**: this component predicts the outcomes of soccer matches based on team statistics, recent performance, and historical match data.
  - **Kernel Methods**: addTeamStatistics(Team team, Statistics stats), recordMatchOutcome(Match match, Outcome outcome), and getTeamPerformance(Team team).
  - **Secondary Methods**: predictMatchOutcome(Team team1, Team team2), suggestStrategy(Team team)

<!-- TODO: brainstorm a component and delete this comment -->
- Component Design #3: Virtual Car Tuning Workshop
  - **Description**: This component offers a virtual environment for tuning and customizing cars within a game, allowing players to modify aspects like paint color, engine upgrades, and wheel types to enhance performance or aesthetics.
  - **Kernel Methods**: changePaintColor(String color), upgradeEngine(EngineUpgrade upgrade),and changeWheels(WheelType wheelType)
  - **Secondary Methods**: applyAerodynamicMods(ModList mods) and simulateCustomizationEffects()
