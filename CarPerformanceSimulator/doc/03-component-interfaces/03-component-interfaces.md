...
I decided to polish up my Car idea a bit. Now, it's all about the key stuff that makes a car act like a car, especially when we're talking about games or simulations. We're focusing on how powerful the engine is, how heavy the car is, and how smoothly it moves through the air. I'm also thinking how we might use smart tech to guess how these things could change a car's performance.
