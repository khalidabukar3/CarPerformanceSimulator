...
> disclose that here as well.
 ...
 I've chosen to zoom in on a simpler idea for this round basically, a piece of code that's all about cars. I'm doing this because I really dig cars and car games, and also, it seems like something I can actually get done This car bit is going to look at the basics of what makes a car tick, like how powerful it is, how heavy it is, The speed gear and how it moves through the air. And I'm going to make it do something cool like figuring out how fast it can speed up. This way, I can keep things doable but still show off what I love and what I've learned.
